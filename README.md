...
- Vue 3 + TypeScript 学生端与教师端工作台，教师端提供独立“智能备课”入口和生成—修订—批准—发布—反馈闭环；两端统一采用不小于 14–16px 的主要阅读与输入字号，长列表及教案详情使用显式分页，避免内部横向或纵向滚动条影响课堂浏览；学生“我的计划”按本周任务、优先补齐和独立规划思路页分层展示，规划说明自动分点并将内部知识编号转换为教材中文名称。
