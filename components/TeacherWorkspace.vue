...
watch(search, () => { studentPage.value = 1; });
...
.teacher-shell{font-size:15px;line-height:1.55}.teacher-shell aside nav button{min-height:48px;font-size:14px}.teacher-shell aside nav>small,.teacher-class-shortcuts>small{font-size:11px}.teacher-class-shortcuts strong{font-size:13px}.teacher-class-shortcuts small,.teacher-profile small{font-size:11px}.teacher-profile strong{font-size:14px}
.teacher-topbar>div small{font-size:11px}.teacher-topbar>div strong{font-size:18px}.teacher-topbar>span,.refresh-teacher{font-size:13px}.teacher-hero small,.teacher-subhero small{font-size:12px}.teacher-hero p,.teacher-subhero p{font-size:15px;line-height:1.75}
.teacher-metrics small,.student-state-metrics small{font-size:13px}.teacher-metrics strong{font-size:24px}.teacher-section>header small{font-size:11px}.teacher-section>header h2{font-size:20px}.teacher-section>header>button,.teacher-section>header>span{min-height:40px;font-size:13px}
.teacher-class-grid h3{font-size:17px}.teacher-class-grid p,.teacher-class-grid footer span,.teacher-class-grid footer button{font-size:13px}.notice-mini strong{font-size:14px}.notice-mini small,.notice-mini article>button{font-size:12px}
